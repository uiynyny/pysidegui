...
class GLGraphicsItem(QtCore.QObject):
    ...
    def setTransform(self, tr):
        ...
        """
        self.__transform = QMatrix4x4(tr)
        self.update()
    ...
    def drawItemTree(self, model_matrix=QMatrix4x4()):
    ...
    def proj_view_matrix(self) -> QMatrix4x4:
        return self.__view.get_proj_view_matrix()

    def proj_matrix(self) -> QMatrix4x4:
    ...
    def applyTransform(self, tr: QMatrix4x4, local=False):
        """
    ...
    def rotate(self, angle, x, y, z, local=False):
        ...
        *angle* is in degrees.
        ...
        """
        self.__transform.rotate(angle, x, y, z)
        return self
